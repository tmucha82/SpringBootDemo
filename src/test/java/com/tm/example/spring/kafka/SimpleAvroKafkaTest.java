...
import com.tm.example.kafka.AvroDeserializer;
import com.tm.example.kafka.AvroSerializer;
...
@SpringBootTest
@EmbeddedKafka
public class SimpleAvroKafkaTest {
  ...
  public void setUp() {
    ...
    consumer = new DefaultKafkaConsumerFactory<>(configs,
        ...
        new AvroDeserializer<>(User.class)).createConsumer();
  ...
  public void test() {
    ...
    Producer<String, User> producer = new DefaultKafkaProducerFactory<>(configs, new StringSerializer(), new AvroSerializer<User>()).createProducer();
